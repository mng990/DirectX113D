...
{
	RESOURCES->Init();
	_shader = make_shared<Shader>(L"14. Material.fx");
	...
	{
		shared_ptr<Material> material = RESOURCES->Get<Material>(L"IceCream");
	...
	{
		shared_ptr<Material> material = RESOURCES->Get<Material>(L"IceCream")->Clone();
		MaterialDesc& desc = material->GetMaterialDesc();
