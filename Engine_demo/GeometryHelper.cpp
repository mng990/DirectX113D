...
void GeometryHelper::CreateCube(shared_ptr<Geometry<VertexTextureData>> geometry)
{
	...
	// æ’∏È
	vtx[0] = VertexTextureData{ Vec3(-w2, -h2, -d2), Vec2(0.f, 1.0f) };
	vtx[1] = VertexTextureData{ Vec3(-w2, +h2, -d2), Vec2(0.f, 0.0f) };
	vtx[2] = VertexTextureData{ Vec3(+w2, +h2, -d2), Vec2(1.f, 0.0f) };
	vtx[3] = VertexTextureData{ Vec3(+w2, -h2, -d2), Vec2(1.f, 1.0f) };

	// µﬁ∏È
	vtx[4] = VertexTextureData{ Vec3(-w2, -h2, +d2), Vec2(1.f, 1.0f) };
	vtx[5] = VertexTextureData{ Vec3(+w2, -h2, +d2), Vec2(0.f, 1.0f) };
	vtx[6] = VertexTextureData{ Vec3(+w2, +h2, +d2), Vec2(0.f, 0.0f) };
	vtx[7] = VertexTextureData{ Vec3(-w2, +h2, +d2), Vec2(1.f, 0.0f) };

	// ¿≠∏È
	vtx[8] = VertexTextureData{ Vec3(-w2, +h2, -d2), Vec2(0.f, 1.0f) };
	vtx[9] = VertexTextureData{ Vec3(-w2, +h2, +d2), Vec2(0.f, 0.0f) };
	vtx[10] = VertexTextureData{ Vec3(+w2, +h2, +d2), Vec2(1.f, 0.0f) };
	vtx[11] = VertexTextureData{ Vec3(+w2, +h2, -d2), Vec2(1.f, 1.0f) };

	// æ∆∑ß∏È
	vtx[12] = VertexTextureData{ Vec3(-w2, -h2, -d2), Vec2(1.f, 1.0f) };
	vtx[13] = VertexTextureData{ Vec3(+w2, -h2, -d2), Vec2(0.f, 1.0f) };
	vtx[14] = VertexTextureData{ Vec3(+w2, -h2, +d2), Vec2(0.f, 0.0f) };
	vtx[15] = VertexTextureData{ Vec3(-w2, -h2, +d2), Vec2(1.f, 0.0f) };

	// øﬁ¬ ∏È
	vtx[16] = VertexTextureData{ Vec3(-w2, -h2, +d2), Vec2(0.f, 1.0f) };
	vtx[17] = VertexTextureData{ Vec3(-w2, +h2, +d2), Vec2(0.f, 0.0f) };
	vtx[18] = VertexTextureData{ Vec3(-w2, +h2, -d2), Vec2(1.f, 0.0f) };
	vtx[19] = VertexTextureData{ Vec3(-w2, -h2, -d2), Vec2(1.f, 1.0f) };


	// ø¿∏•¬ ∏È
	vtx[20] = VertexTextureData{ Vec3(+w2, -h2, -d2), Vec2(0.f, 1.0f) };
	vtx[21] = VertexTextureData{ Vec3(+w2, +h2, -d2), Vec2(0.f, 0.0f) };
	vtx[22] = VertexTextureData{ Vec3(+w2, +h2, +d2), Vec2(1.f, 0.0f) };
	vtx[23] = VertexTextureData{ Vec3(+w2, -h2, +d2), Vec2(1.f, 1.0f) };
...
{
	float radius = 0.5f; // ±∏¿« π›¡ˆ∏ß
	uint32 stackCount = 50; // ∞°∑Œ ∫–«“
	uint32 sliceCount = 50; // ºº∑Œ ∫–«“
